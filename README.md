...
> :star: **実装を引き継ぐコーダーの方は、まず [`docs/handoff.md`](./docs/handoff.md)（引き継ぎメモ）から読んでください。**
...
- :building_construction: **構成と仕組み（コーダー向け）**: [`docs/architecture.md`](./docs/architecture.md)
  - ルーティングの仕組みや「デザインのこの部分はどのファイル」の対応表など、UI を実装する人向け
...
├── docs/                # チーム向けドキュメント
│   ├── handoff.md           # 引き継ぎメモ（コーダーはまずここ）
│   ├── astro-onboarding.md  # Astro 入門スライド（Marp）
│   ├── content-editing.md   # コンテンツ編集ガイド（文言・データ）
│   └── architecture.md      # 構成と仕組み（コーダー向け）
